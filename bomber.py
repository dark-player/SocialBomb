...
def do_zip_update():
    success = False
    if DEBUG_MODE:
        zip_url = "https://github.com/dark-player/SocialBomb/archive/dev.zip"
        dir_name = "SocialBomb-dev"
    else:
        zip_url = "https://github.com/dark-player/SocialBomb/archive/master.zip"
        dir_name = "SocialBomb-master"
    ...
    if success:
        mesgdcrt.SuccessMessage("SocialBomb was updated to the latest version")
        mesgdcrt.GeneralMessage(
            "Please run the script again to load the latest version")
    else:
        mesgdcrt.FailureMessage("Unable to update SocialBomb.")
        mesgdcrt.WarningMessage(
            "Grab The Latest one From https://github.com/dark-player/socialBomb.git")
...
def do_git_update():
    ...
    if success:
        ...
        print(
            "git checkout . && "
            "git pull https://github.com/dark-player/SocialBomb.git HEAD")
    sys.exit()
...
def check_for_updates():
    ...
    fver = requests.get(
        "https://raw.githubusercontent.com/dark-player/SocialBomb/master/.version"
    ).text.strip()
    if fver != __VERSION__:
        ...
        mesgdcrt.SuccessMessage("SocialBomb is up-to-date")
...
def notifyen():
    try:
        if DEBUG_MODE:
            url = "https://github.com/dark-player/SocialBomb/raw/dev/.notify"
        else:
            url = "https://github.com/dark-player/SocialBomb/raw/master/.notify"
...
def pretty_print(cc, target, success, failed):
    ...
    mesgdcrt.SuccessMessage("SocialBomb is made by Spooky Hackers ")
...
description = """SocialBomb - Your Friendly Spammer Social Media Application 

SocialBomb can be used for many purposes which incudes -
\t Exposing the vulnerable APIs over Internet
\t Friendly Spamming
\t Testing Your Spam Detector and more ....

SocialBomb is not intented for malicious uses.
"""

parser = argparse.ArgumentParser(description=description,
                                 epilog='Coded by Spooky Hackers !!!')
