...
banner() {
    ...
    if ! [ -x "$(command -v toilet)" ]; then
        ...
        toilet -f mono12 -F border Spooky Hackers
    fi
    echo -e "\e[1;34m For Any Queries Join Me!!!\e[0m"
    echo -e "\e[1;32m           Telegram: https://t.me/spookyhackers \e[0m"
    echo -e "\e[4;32m   YouTube: https://www.youtube.com/c/spookyhackers \e[0m"
    echo " "
    echo "NOTE: Kindly move to the PIP version Of SocialBomb for more stability."
    echo " "
}
...
if [ -f .update ];then
    ...
    echo .
    install_deps
    echo This Script Was Made By Spooky Hackers > .update
